...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      // Remove backgrounds but keep bottom borders for all form elements
      // Add temporary style to force transparent backgrounds with !important
      var tempStyle = document.createElement("style");
      tempStyle.id = "temp-pdf-style-clearance";
      tempStyle.textContent = `
        #medicalClearance .form-control,
        #medicalClearance input,
        #medicalClearance textarea,
        #medicalClearance span.form-control,
        #medicalClearance div.form-control {
        ...
        /* Keep all existing bottom borders */
        #medicalClearance input[type="text"],
        #medicalClearance input[type="date"],
        #medicalClearance textarea {
      ...
      var borderRemoved = [];
      clearanceDiv
        .querySelectorAll("input, textarea, .form-control, span, div")
        .forEach(function (el) {
          borderRemoved.push({
            el: el,
          ...
          // Remove top, left, right borders and border-radius but keep bottom border
      ...
      // Apply PDF export styles to ensure black text
      document.body.classList.add("pdf-export");
      clearanceDiv.style.color = "#000";
      clearanceDiv.style.backgroundColor = "#fff";

      // Force all text elements in clearance to black
      clearanceDiv.querySelectorAll("*").forEach(function (el) {
      ...
      html2canvas(clearanceDiv, {
        ...
        // Reset PDF export styles
        document.body.classList.remove("pdf-export");
        clearanceDiv.style.color = "";
        clearanceDiv.style.backgroundColor = "";
        ...
        borderRemoved.forEach(function (obj) {
          ...
          obj.el.style.backgroundColor = obj.backgroundColor;
          obj.el.style.borderRadius = obj.borderRadius;
        });

        // Remove temporary style
        var tempPdfStyle = document.getElementById("temp-pdf-style-clearance");
        if (tempPdfStyle) tempPdfStyle.remove();
      });
    });
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      // 4. Remove borders and backgrounds from prescription blocks
      // Add temporary style to force transparent backgrounds with !important
      var tempStyle = document.createElement("style");
      tempStyle.id = "temp-pdf-style-prescription";
      tempStyle.textContent = `
      ...
      var borderRemoved = [];
      prescriptionDiv
        .querySelectorAll(".form-control, input, textarea")
        .forEach(function (el) {
          borderRemoved.push({
            el: el,
            border: el.style.border,
      ...
      // Apply PDF export styles to ensure black text
      document.body.classList.add("pdf-export");
      prescriptionDiv.style.color = "#000";
      prescriptionDiv.style.backgroundColor = "#fff";

      // Force all text elements in prescription to black
      prescriptionDiv.querySelectorAll("*").forEach(function (el) {
        el.style.setProperty("color", "#000", "important");
        if (
          el.style.backgroundColor &&
          el.style.backgroundColor !== "transparent"
      ...
      html2canvas(prescriptionDiv, {
        ...
        // Reset PDF export styles
        document.body.classList.remove("pdf-export");
        prescriptionDiv.style.color = "";
        prescriptionDiv.style.backgroundColor = "";
        ...
        var tempPdfStyle = document.getElementById(
          "temp-pdf-style-prescription"
        );
        if (tempPdfStyle) tempPdfStyle.remove();
      });
    });
  ...
  document
    ...
    .addEventListener("click", function () {
      ...
      // Remove borders and backgrounds from form-control elements
      // Add temporary style to force transparent backgrounds with !important
      var tempStyle = document.createElement("style");
      tempStyle.id = "temp-pdf-style-certificate";
      tempStyle.textContent = `
        #certificate .form-control,
        #certificate input,
        #certificate textarea,
        #certificate span.form-control,
        #certificate div.form-control {
          background: transparent !important;
          background-color: transparent !important;
          border: none !important;
        }
      ...
      var borderRemoved = [];
      certificateDiv
        .querySelectorAll(".form-control, input, textarea, span, div")
        .forEach(function (el) {
          borderRemoved.push({
            el: el,
            border: el.style.border,
      ...
      // Force all text elements in certificate to black
      certificateDiv.querySelectorAll("*").forEach(function (el) {
        el.style.setProperty("color", "#000", "important");
        if (
          el.style.backgroundColor &&
          el.style.backgroundColor !== "transparent"
      ...
      html2canvas(certificateDiv, {
        ...
        // Reset PDF export styles
        document.body.classList.remove("pdf-export");
        certificateDiv.style.color = "";
        certificateDiv.style.backgroundColor = "";
