...
async function generateComprehensiveBillingPDF(procedureData, procedureId) {
  ...
  try {
    ...
    // Display 'Remarks:' label first, then remarks text below
    doc.setFont(undefined, "bold");
    doc.text("Remarks:", rightX, rightY);
    doc.setFont(undefined, "normal");
    rightY += 7;
    const remarksLines = doc.splitTextToSize(remarks, 70); // wrap text at 70 width
