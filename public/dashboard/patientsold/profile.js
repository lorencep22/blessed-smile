  ...
  return `
        <svg viewBox="0 0 50 50" width="32" height="32" style="margin:1px;">
            <g transform="rotate(45,25,25)">
                <circle id="Occlusal" class="section" cx="25" cy="25" r="10"></circle>
                <path id="Mesial" class="section" d="M25,5 A20,20 0 0,1 45,25 L35,25 A10,10 0 0,0 25,15 Z"></path>
                <path id="Lingual" class="section" d="M45,25 A20,20 0 0,1 25,45 L25,35 A10,10 0 0,0 35,25 Z"></path>
                <path id="Distal" class="section" d="M25,45 A20,20 0 0,1 5,25 L15,25 A10,10 0 0,0 25,35 Z"></path>
                <path id="Labial" class="section" d="M5,25 A20,20 0 0,1 25,5 L25,15 A10,10 0 0,0 15,25 Z"></path>
            </g>
        </svg>`;
}
